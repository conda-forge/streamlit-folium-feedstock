...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/streamlit-folium-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11840&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/streamlit-folium-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `streamlit-folium` can be installed with:

```
conda install streamlit-folium
```

It is possible to list all of the versions of `streamlit-folium` available on your platform with:
